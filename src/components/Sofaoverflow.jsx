...
import Sofaimg_2 from "../assets/images/sofa-img2.webp"
     ...
     <div className='bg-[#F7F7F8] pt-[64px] relative z-[1] '>
        <div className='max-w-[1320px] container px-3 mx-auto'  >
          <div className="row justify-center">
            ...
            <div className='lg:w-7/12 px-3 mt-8 lg:mt-0'>
              <img src={Sofaimg_2} alt="sofaimg" className='lg:w-full max-lg:max-w-[500px] w-full relative z-[2]' />
            </div>
          </div>
        </div >
