...
import TrendingImg1 from "../assets/images/trending1.webp";
import TrendingImg2 from "../assets/images/trending2.webp";
import TrendingImg3 from "../assets/images/treanding3.webp";
import { Star } from "./icon";
const ProductData = [
  {
    id: 1,
    ProductImg: TrendingImg1,
    Rating: <Star />,
    Product: "Single Sofa",
    Price: "₹ 1200.00",
  },
        ...
        >
          <div>
            <div className="sm:flex items-center sm:gap-[9px]">
              ...
              <p className="sm:text-xl text-base text-center text-[#BD7D41] max-sm:text-center font-poppins">
                Shopping Store
              </p>
            </div>
            <h2 className=" pt-4 sm:pt-[29px] max-sm:text-center text-xl sm:text-[35px] font-poppins font-bold leading-normal max-w-[436px]">
...
export default Trendingfurniture;
